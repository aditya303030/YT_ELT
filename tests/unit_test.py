def test_api_key(api_key):
    # test if api_key is in fact equal to what we defined in the fixture
    # which should be MOCK_KEY1234
...
def test_dags_integrity(dagbag):
    # Split the integrity test into 4 parts:
    # 1. There will be no import errors
    # 2. Border Dags we defined are being loaded
    ...
    # this is to get actual dag ids from dag keys
